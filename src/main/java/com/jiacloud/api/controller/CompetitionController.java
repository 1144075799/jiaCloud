...
//        System.out.println(competition.getName());
    ...
    @CrossOrigin
    @RequestMapping(value = "/uploadCompetitionsImg", method = RequestMethod.POST)
    /**项目图片上传类**/
    public String uploadCompetitionsImg(@RequestParam("file") MultipartFile file, HttpServletRequest request, HttpServletResponse response) throws IllegalStateException, IOException {
        ...
        if (imageTyepLists.contains(extendName)) {
            ...
            //把文档的路径写入数据库
            competitionService.addImagePath(DocPath,name);
    ...
    /**项目文件上传类**/
    public String uploadCompetitionsDoc(@RequestParam("file") MultipartFile file, HttpServletRequest request, HttpServletResponse response) throws IllegalStateException, IOException {
